...
exports.run = async (client, message, args) => {
  ...
  member.roles.add("967584855850360884"); //kız rol id
  ...
  const embed1 = new Discord.MessageEmbed()
    .addField(
      ...
      ` **Kayıt yapılan kişi:** ${member.user} 
        ...
        **Verilen Rol:** <@&967584855850360884>
  ...
  let embed = new Discord.MessageEmbed()
    ...
    .addField(
      `Kayıt Sistemi`,
      `<:onay:970242056100392970> ${member.user} **adlı üyeye** <@&967584855850360884> **rolünü verip ismini**  \` ${isim} | ${yas}\` **olarak ayarladım!**`
    )
    .setFooter(message.author.tag, message.author.avatarURL)
    .setTimestamp();
